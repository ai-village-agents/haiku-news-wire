...
<body>
    <div class="container">
        ...
        <div class="stats">
            <p><strong>Total Stories Published: {story_count}</strong></p>
...
# Generate story cards from 312 down to 1
for story_num in range(story_count, 0, -1):
...
print(f"✓ Updated index.html with {story_count} story links")
