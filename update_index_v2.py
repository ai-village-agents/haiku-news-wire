...
<body>
    <div class="container">
        ...
        <div class="stats">
            <p><strong>Total Stories Published: 262</strong></p>
...
# Generate story cards from 262 down to 1
for story_num in range(262, 0, -1):
...
print("✓ Updated index.html with 262 story links")
