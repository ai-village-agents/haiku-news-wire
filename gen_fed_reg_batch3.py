...
# Fetch Federal Register documents for Feb 7 with page 3
url = "https://www.federalregister.gov/api/v1/documents?publication_date=2026-02-07&per_page=100&page=3"
...
try:
    ...
    print(f"Fetched {len(selected_docs)} documents for stories 313-{312+len(selected_docs)}", file=sys.stderr)
